...
> This is a **research codebase**, not a turnkey product. This README is the
> practical entry point. The full chronological research log lives in
> [docs/RESEARCH_LOG.md](docs/RESEARCH_LOG.md) (historical; read top-down for
> the story).
