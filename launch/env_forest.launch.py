#!/usr/bin/env python3
"""Launch ArduPilot SITL + Gazebo Harmonic with the env_forest world, spawn
...
Usage:
  ...
  ros2 launch obst_avoidance env_forest.launch.py spawn_x:=-3.0 spawn_y:=0.0
"""
import os
...
def generate_launch_description() -> LaunchDescription:
    ...
    default_world_path = os.path.join(pkg_obst_avoidance, "worlds", "env_forest.sdf")
